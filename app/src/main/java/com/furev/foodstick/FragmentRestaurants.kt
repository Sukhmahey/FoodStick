...
import com.furev.foodstick.databinding.FragmentRestaurantsBinding
...
class FragmentRestaurants : Fragment() {
    val restaurantlist= ArrayList<RestaurantList>()
    ...
    override fun onCreateView(
        ...
        val binding: FragmentRestaurantsBinding = DataBindingUtil.inflate(inflater,R.layout.fragment_restaurants, container, false)
                ...
                Response.Listener {
                    try {
                        ...
                        if (success) {
                            ...
                            recyclerAdapter =
                                RestaurantRecyclerAdapter(activity as Context, restaurantlist,this)
